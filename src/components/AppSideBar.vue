 ...
 * @LastEditTime: 2022-01-26 12:12:39
...
<script>
import docRoutes from '@/router/routes.js';
 ...
 .tracer-doc-side {
    ...
    &::-webkit-scrollbar {
      ...
      .router-link-exact-active {
        color: var(--doc-color-primary);
        background-color: var(--doc-color-side-bar-active-background);
        border-radius: 3px;
      }
